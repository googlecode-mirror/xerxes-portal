...
class Xerxes_Framework_Cache extends Xerxes_Framework_DataMap
{
	...
	public function set( $id, $data, $expiry = null )
	{
		...
		if ( $id == "" )
		{
			throw new Exception("you must supply an id for the cache");
		}
		
		if ( $data == "" )
		{
			throw new Exception("cached data was empty");
		}		
